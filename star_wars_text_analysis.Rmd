...
# Notes on the coding style I follow:
# I aim for 70 +/- 2 char line lengths
# If I start forming multiple nested functions, I will break
# if clarity is being impacted. 
...
theme_set(theme_bw()) # set a theme for all ggplots
...
```{r star wars script extraction example}
...
```{r star wars script extractions, echo = FALSE}

# extracting the rest of the scripts
...
```{r extract force awakens and analyze}
